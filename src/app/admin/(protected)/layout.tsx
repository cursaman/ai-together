  ...
  return (
    <div className={styles.adminShell}>
      <header className={styles.adminHeader}>
        <Link className={styles.adminBrand} href="/admin" aria-label="AI Together 관리자 홈"><span className={styles.adminBrandAi}>AI</span><span>Together</span><span className={styles.adminBadge}>관리자</span></Link>
