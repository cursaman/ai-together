...
const showcases = [
  { number:"01",title:"오늘 뭐 빌리지?",type:"BOOK RECOMMENDATION",description:"기분과 읽을 시간을 고르면 가까운 도서관에서 빌릴 책을 추천하는 서비스형 홈페이지입니다.",href:"https://what-to-borrow.vercel.app/" },
  { number:"02",title:"오늘 뭐하지?",type:"ACTIVITY PLANNER",description:"날씨·시간·지역·취향을 바탕으로 오늘의 활동을 추천하고 일정을 구성하는 홈페이지입니다.",href:"https://today-what-pi.vercel.app/" },
  { number:"03",title:"TECHCARE",type:"TECH SUPPORT",description:"복합기 오류 코드와 증상을 검색해 원인과 현장 해결 방법을 확인하는 기술지원 홈페이지입니다.",href:"https://tech-seven-gamma.vercel.app/" },
  { number:"04",title:"EDU 웹개발",type:"EDUCATION",description:"웹 기초부터 React, GitHub와 Vercel 배포까지 단계별로 안내하는 웹개발 교육 홈페이지입니다.",href:"https://edu-two-indol.vercel.app/" },
  { number:"05",title:"무비픽",type:"MOVIE API",description:"인기·상영 영화와 프로그램을 탐색하고 취향에 맞는 작품을 검색·보관하는 영화 API 홈페이지입니다.",href:"https://movie-delta-liard.vercel.app/" },
