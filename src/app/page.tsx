...
export default function Home() {
  return <>
    <aside className="resource-bar" aria-label="홈페이지 교육 안내"><span>홈페이지 만들기가 궁금하신가요?</span><a href="https://autosites-jd3d.vercel.app/" target="_blank" rel="noreferrer">4주 홈페이지 과정 ↗</a><a href="https://homepages-rosy.vercel.app/" target="_blank" rel="noreferrer">홈페이지 제작 실습 ↗</a><a href="https://what-to-ai.vercel.app/" target="_blank" rel="noreferrer">AI 개발 가이드 ↗</a><a href="https://what-to-db.vercel.app/" target="_blank" rel="noreferrer">DB·회원가입 실습 ↗</a></aside>
    <header className="site-header"><div className="nav-shell"><Link className="brand" href="/" aria-label="AI Together 홈"><span className="brand-mark" aria-hidden="true">✦</span><span>AI TOGETHER</span></Link><nav className="desktop-nav" aria-label="주요 메뉴"><Link href="/meetings">모임</Link><Link href="/guide">처음 오셨나요?</Link><Link href="/reviews">후기</Link><Link href="/contact">문의</Link><Link href="/resources">참고자료</Link></nav><Link className="nav-cta" href="/meetings">모임 찾기</Link><MobileMenu /></div></header>
