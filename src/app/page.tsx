...
export default async function Home() {
  ...
  return <>
    ...
    <main id="main-content">
      ...
      <section className="visit-section" aria-labelledby="visit-title"><div><p>LOCATION & PREPARATION</p><h2 id="visit-title">커피와 빵은 준비할게요.<br />노트북만 챙겨오세요.</h2><ul><li><strong>장소</strong><span>부산 교대 인근 커피긱스 2층 8인룸</span></li><li><strong>카페 이용</strong><span>커피·빵 50,000원은 진행자가 참가비에서 일괄 결제</span></li><li><strong>추가 결제</strong><span>참가자는 별도 공간 이용료와 음료 결제 없음</span></li><li><strong>준비물</strong><span>개인 노트북과 충전기</span></li></ul><Link className="text-link" href="/contact">장소와 이용 안내 자세히 보기 →</Link></div><div className="visit-visual" aria-hidden="true"><span>☕</span><strong>커피와 빵 포함</strong><small>진행자 결제 · 참가자 추가 비용 없음</small></div></section>
