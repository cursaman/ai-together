...
export const metadata: Metadata = { title: "처음 오셨나요? | AI Together", description: "AI Together 모임의 참여 방법과 준비물을 안내합니다." };
